  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title"> Cetak Data Nilai Rapor</h4>
      </div>
      ...
      <div class="modal-body">
        <form action="data/data_raport/laporan_raport.php" method="post" target="_blank">
          <table>
            ...
            <!-- Pilih Tahun Ajaran -->
            <tr>
              <td><div class="form-group">Tahun Ajaran</div></td>
              <td align="center" width="5%"><div class="form-group">:</div></td>
              <td>
                <div class="form-group">
                  <select class="form-control" id="thn_ajar" name="thn_ajar" required>
            ...
            <!-- ✅ Pilih Semester -->
            <tr>
              <td><div class="form-group">Semester</div></td>
              <td align="center"><div class="form-group">:</div></td>
              <td>
                <div class="form-group">
