...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>RAPOR</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>RAPOR</b></span>
    </a>
...
if (isset($_SESSION['Admin'])) {
    ...
    $user2 = $_SESSION['guru'];
} elseif (isset($_SESSION['ketua'])) {
    $user4 = $_SESSION['ketua']; // Ketua pakai tb_staf juga
}
...
if (isset($result1) && mysqli_num_rows($result1) > 0) {
    echo '<div class="user-panel">
            <div class="pull-left image">
                <img src="img/foto/staf/' . htmlspecialchars($admin["foto"]) . '" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
                <p>' . htmlspecialchars($admin['nama_staf']) . '</p>
                <!-- Status -->
                <a href="#"><i class="fa fa-circle text-success"></i> ' . htmlspecialchars($admin['level']) . '</a>
            </div>
        </div>';
} elseif (isset($result2) && mysqli_num_rows($result2) > 0) {
    echo '<div class="user-panel">
            <div class="pull-left image">
                <img src="img/foto/guru/' . htmlspecialchars($guru["foto"]) . '" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
                <p>' . htmlspecialchars($guru['nama_guru']) . '</p>
                <!-- Status -->
                <a href="#"><i class="fa fa-circle text-success"></i> Guru</a>
            </div>
        </div>';
} elseif (isset($result3) && mysqli_num_rows($result3) > 0) {
    echo '<div class="user-panel">
            <div class="pull-left image">
                <img src="img/foto/siswa/' . htmlspecialchars($siswa["foto"]) . '" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
                <p>' . htmlspecialchars($siswa['nama_siswa']) . '</p>
                <!-- Status -->
...
?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="?page=raport_siswa"><i class="fa fa-circle-o"></i> <span>Data rapor</span></a></li>
		</ul>
        </li>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
		...
		<?php
					...
					if ($page == "raport_siswa") {
						if ($aksi == "") {
							include "data/data_raport_siswa/raport_siswa.php";
						}elseif ($aksi == "tambah"){
							include "data/data_materi/tambah.php";
						}
					}
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
<strong>
  Copyright &copy; <?php echo date("Y"); ?> <a href="#"></a>.
</strong> All rights reserved. | Repost by 
<a href='' target=''>MASJID DARUL MUKHLISIN</a>
